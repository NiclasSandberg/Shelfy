...
INSERT INTO product(id, name, description, date_opened, expiry_date, period_after_opening, category_id) VALUES (12345, 'Sunscreen', 'Use daily','2022-12-31', '2023-07-21', 2, 2);
INSERT INTO product(id, name, description, date_opened, expiry_date, period_after_opening, category_id) VALUES (1234, 'Mascara', 'This is my mascara','2023-01-01', '2023-06-14', 1, 1);
INSERT INTO product(id, name, description, date_opened, expiry_date, period_after_opening, category_id) VALUES (123, 'Brush', 'This is my brush','2022-01-01', '2023-03-26', 3, 3);