...
INSERT INTO product(id, name, description, date_opened, expiry_date, period_after_opening, category_id) VALUES (12345, 'Sunscreen', 'Use daily','2023-03-29', '2024-03-29', 12, 2);
INSERT INTO product(id, name, description, date_opened, expiry_date, period_after_opening, category_id) VALUES (1234, 'Mascara', 'From the brand Benefit, black, lengthening.','2023-01-01', '2023-06-01', 6, 1);
INSERT INTO product(id, name, description, date_opened, expiry_date, period_after_opening, category_id) VALUES (1239, 'Leave-in Conditioner', 'Heat protection product from this famous brand.','2023-01-01', '2023-09-01', 9, 3);
