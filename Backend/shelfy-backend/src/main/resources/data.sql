...
INSERT INTO product(product_id, name, description, date_opened, expiry_date, period_after_opening, category_id, user_id) VALUES (12345, 'Sunscreen', 'Use daily','2023-03-29', '2024-03-29', 12, 2, 'google-oauth2|112693144342926124708');
...
INSERT INTO product(product_id, name, description, date_opened, expiry_date, period_after_opening, category_id, user_id) VALUES (1239, 'Leave-in Conditioner', 'Heat protection product from this famous brand.','2023-01-01', '2023-09-01', 9, 3, 'google-oauth2|110696447515674967588');
...
INSERT INTO product(product_id, name, description, date_opened, expiry_date, period_after_opening, category_id, user_id) VALUES (123456, 'Cold medicine', 'In the medicine cabinet behind the towels.','2022-03-21', '2024-03-21', 24, 4, '888');
